...
class HideDeveloperStatus : Fragment(R.layout.hide_developer_status_layout) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        requireActivity().setTitle(R.string.hide_developer_status_title)
    ...
    private fun getInitialCheckedList(): List<String> {
        val flattenedString = Settings.Secure.getString(
            requireContext().contentResolver, Settings.Secure.HIDE_DEVELOPER_STATUS
        )
